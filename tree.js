...
export class Tree extends THREE.Group {
    constructor(opt) {
        ...
        super(opt)
        opt = opt || {};
        this.sections = opt.sections || 15;
        this.conesPerSection = opt.conesPerSection || 17;
        this.coneMaterial = opt.coneMaterial || new THREE.MeshBasicMaterial({
            color: 0x00ff00
        });
        this.coneMaxRadius = opt.coneMaxRadius || 0.7 / 1609;
        this.coneRadiusReduction = opt.coneRadiusReduction || 0.3 / 1609;
        this.coneMaxLength = opt.coneRadiusReduction || 5 / 1609;
        this.coneLengthReduction = opt.coneLengthReduction || 4.5 / 1609;
        // call backs
    ...
    static defaultConeObj(tree, coneObj, secObj) {
    ...
    static setConePos(coneObj, secObj) {
